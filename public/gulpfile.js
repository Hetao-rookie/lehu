...
gulp.task('browser', function() {
  ...
  // 监听JS控制器文件的添加和删除
  watch('./src/js/controllers/**/*.js', gulp.series('inject-controllers'));

  // 监听JS模型文件的添加和删除
  watch('./src/js/models/**/*.js', gulp.series('inject-models'));

  // 监听图片的添加和删除，生成图片地图，供JS引用图片的调用，服务于版本号功能
  watch('./src/images/**/*.*', gulp.series('js-images-map'));

  //监听package.json文件
  watch("./package.json", gulp.series('version-js'));
